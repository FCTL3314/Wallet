...
class StorageLocation(Base):
    ...
    __table_args__ = (
        UniqueConstraint("name", "user_id", name="uq_storage_location_name_user"),
    )
...
class StorageAccount(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "storage_location_id", "currency_id", name="uq_storage_account_loc_cur"
        ),
    )
    ...
    storage_location = relationship(
        "StorageLocation", back_populates="storage_accounts"
    )
