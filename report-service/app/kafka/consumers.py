...
from wallet_sdk.kafka.schemas import ReportCompletedMsg, ReportRequestedMsg
from wallet_sdk.kafka.topics import REPORT_COMPLETED, REPORT_REQUESTED
...
@broker.subscriber(REPORT_REQUESTED)
@broker.publisher(REPORT_COMPLETED)
