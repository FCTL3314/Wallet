  ...
  <div class="auth-page">
    <div class="auth-card">
      ...
      <div class="oauth-buttons">
        <button type="button" class="btn-oauth" @click="signInWithGitHub">
          <svg width="20" height="20" viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <button type="button" class="btn-oauth" @click="signInWithGoogle">
